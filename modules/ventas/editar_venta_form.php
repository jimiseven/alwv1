...
$sqlVenta = "SELECT * FROM ventas WHERE id = $venta_id";
$resVenta = mysqli_query($conn, $sqlVenta);
...
<head>
    ...
    <title>Editar Venta - Sistema ALW</title>
    ...
    <div class="main-content">
        <div class="form-card">
            <div class="form-header">
                <h1><i class="bi bi-pencil-square"></i> Editar Venta</h1>
                <p>Actualiza los datos de la venta</p>
            </div>
            ...
            <form id="formEditarVenta" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="numero_celular" id="numero_celular" required autofocus value="<?php echo htmlspecialchars($venta['numero_celular']); ?>" placeholder="Ej: 555-1234">
                </div>
                    ...
                    <select class="form-select" name="cuenta_id" id="cuenta_id" required>
                        ...
                        if ($resCuentas && mysqli_num_rows($resCuentas) > 0) {
                            while ($cuenta = mysqli_fetch_assoc($resCuentas)) {
                                ...
                                $selected = ($cuenta['id'] == $venta['cuenta_id']) ? 'selected' : '';
                                echo "<option value='{$cuenta['id']}' $selected>". 
                                     $tipoLetra . " " .
                ...
                <div class="form-row">
                    <div>
                        ...
                        <input type="date" class="form-control" name="fecha_inicio" id="fecha_inicio" required value="<?php echo $venta['fecha_inicio']; ?>">
                    </div>
                    <div>
                        <label for="fecha_fin" class="form-label">Fecha fin</label>
                        <input type="date" class="form-control" name="fecha_fin" id="fecha_fin" required value="<?php echo $venta['fecha_fin']; ?>">
                    </div>
                </div>

                <div class="form-group">
                    <label for="pago" class="form-label">Pago</label>
                    <input type="number" step="0.01" class="form-control" name="pago" id="pago" required placeholder="0.00" value="<?php echo $venta['pago']; ?>">
                </div>
